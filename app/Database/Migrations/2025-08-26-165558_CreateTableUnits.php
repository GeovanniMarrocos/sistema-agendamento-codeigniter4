     ...
     public function up()
    {
        $this->forge->addField([
            ...
            'services' => [
                ...
                'null'           => true,
                'default'        => null,
                'comment'        => 'Conterá os indentificadores dos serviços. Exemplo: ["1", "2", "..."]'
            ],
             ...
             'starttime' => [
                ...
                'comment'        => 'Horário em que a unidade inicia o expediente. Esse valor é usado para calcular e exibir os horários
                                    disponíveis da unidade. Exemplo: 08:00'
            ],
             ...
             'endtime' => [
                ...
                'comment'        => 'Horário em que a unidade finaliza o expediente. Esse valor é usado para calcular e exibir os horários
                                    disponíveis da unidade. Exemplo: 18:00'
            ],

             'servicetime' => [
                'type'           => 'VARCHAR',
                'constraint'     => 20,
                'comment'        => 'Tempo necessário par cada atendimento. Exemplo: 1 hour, 10 minutes,  2 hours'
            ],
