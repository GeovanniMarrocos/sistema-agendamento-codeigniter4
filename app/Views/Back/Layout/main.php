...
<head>
    ...
    <!-- Espaço reservado para CSS de páginas específicas  -->
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">SUPER USUÁRIO</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Espaço reservado para apresentar o conteúdo específico das views que extendem esse template -->
    ...
    <!-- Espaço reservado para scripts o específicos das views que extendem esse template -->
